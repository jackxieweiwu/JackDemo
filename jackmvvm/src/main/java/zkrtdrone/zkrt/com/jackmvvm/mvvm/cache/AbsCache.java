package zkrtdrone.zkrt.com.jackmvvm.mvvm.cache;
...
import zkrtdrone.zkrt.com.jackmvvm.mvvm.util.AppUtils;
import zkrtdrone.zkrt.com.jackmvvm.mvvm.util.StreamUtil;
...
import zkrtdrone.zkrt.com.jackmvvm.mvvm.cache.diskcache.DiskLruCache;
    ...
    byte[] readDiskCache(@NonNull String key) {
        ...
        if (useDisk) {
            synchronized (LOCK) {
                ...
                try {
                    zkrtdrone.zkrt.com.jackmvvm.mvvm.cache.diskcache.DiskLruCache.Snapshot snapshot = mDiskLruCache.get(hashKey);
                    if (snapshot != null) {
